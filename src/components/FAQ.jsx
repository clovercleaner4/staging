    ...
    const questions = [
        {
            ...
            a: '当店では、哺乳瓶を洗えるほど安全な「天然植物性エコ洗剤」を中心に使用しております。塩素系の強いニオイもなく、アレルギーをお持ちの方や、小さなお子様・ペットがいるご家庭でも安心してご利用いただけます。'
        },
        {
        ...
        {
            q: '万が一、作業中に破損事故などが起きた場合は？',
            a: '細心の注意を払って作業しておりますが、万が一の破損等に備え、「三井住友海上 賠償責任保険」に加入しております。責任を持って対応させていただきますので、安心してご依頼ください。'
        }
    ];
