...
export const metadata = {
  ...
  title: {
    default: "春日井市のエアコンクリーニング【激安・地域安値】｜クローバークリーナー",
    template: "%s | クローバークリーナー"
  },
  description: "春日井市・小牧・名古屋へ出張。夫婦で営む丁寧なお掃除屋です。エアコンクリーニング1台8,000円〜の激安価格で徹底洗浄！地域安値に挑戦中。女性スタッフ同行可能で一人暮らしも安心。",
  keywords: ["春日井市", "エアコンクリーニング", "ハウスクリーニング", "激安", "格安", "安い", "お掃除代行", "小牧市", "名古屋市", "プロの掃除", "女性スタッフ同行"],
